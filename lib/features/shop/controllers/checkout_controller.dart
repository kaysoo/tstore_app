...
import 'package:tstore_app/common/widgets/list_tiles/payment_tile.dart';
import 'package:tstore_app/common/widgets/text/section_heading.dart';
import 'package:tstore_app/features/shop/models/payment_method_model.dart';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TPaymentTile(
                        paymentMethod: PaymentMethodModel(
                            image: TImages.visaCard, name: 'VISA')),
                    const SizedBox(
                      height: TSizes.spaceBtwItems / 2,
                    ),
                    TPaymentTile(
